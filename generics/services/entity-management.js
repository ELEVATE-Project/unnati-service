...
const ENTITY_SERVICE_URL = process.env.ENTITY_SERVICE_URL;
  ...
  userToken
    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            const url = ENTITY_SERVICE_URL + CONSTANTS.endpoints.FIND_ENTITY_DOCUMENTS;
            const options = {
                headers : {
...
const entityTypeDocuments = function ( 
  filterData =  "all",
  projection = "all",
  userToken
) {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            const url = ENTITY_SERVICE_URL + CONSTANTS.endpoints.FIND_ENTITY_TYPE_DOCUMENTS;
            const options = {
                headers : {
                    "content-type": "application/json",
                    "internal-access-token": process.env.INTERNAL_ACCESS_TOKEN,
