...
module.exports = class CertificateTemplatesHelper {
	...
	static create(data) {
		return new Promise(async (resolve, reject) => {
			try {
				let certificateTemplateCreated = await database.models.certificateTemplates.create(data)
				return resolve({
	...
	static update(templateId, data) {
		return new Promise(async (resolve, reject) => {
			try {
				...
				let certificateTemplateUpdated = await database.models.certificateTemplates.findOneAndUpdate(
					{ _id: templateId },
					updateObject
				)
