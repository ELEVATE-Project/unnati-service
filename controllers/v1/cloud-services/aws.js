...
module.exports = class Aws {
    ...
    /**
     * @api {post} /project/v1/cloud-services/aws/getDownloadableUrl  
     ...
     * "bucketName": ""
     * }
     * @apiSampleRequest /project/v1/cloud-services/aws/getDownloadableUrl
     * @apiUse successBody
     * @apiUse errorBody
    ...
    */
    ...
    /**
     * @api {post} /project/v1/cloud-services/aws/preSignedUrls  
     * Get signed URL.
     * @apiVersion 1.0.0
     * @apiGroup Aws
     * @apiHeader {String} X-authenticated-user-token Authenticity token
     ...
     * }
     * @apiSampleRequest /project/v1/cloud-services/aws/preSignedUrls
     * @apiUse successBody
     * @apiUse errorBody
     * @apiParamExample {json} Response:
     * {
 ...
 /**
     * @api {post} /project/v1/cloud-services/aws/uploadFile  
     * Upload file to AWS
     * @apiVersion 1.0.0
     * @apiGroup Aws
     * @apiHeader {String} X-authenticated-user-token Authenticity token
     ...
     *  
     * }
     * @apiSampleRequest /project/v1/cloud-services/aws/uploadFile
     * @apiUse successBody
     * @apiUse errorBody
     * @apiParamExample {json} Response:
     * {
